...
shape_initial <- chc2Out(
  here(
    ...
    "ventral_silhouette",
    "Siratus_michelae_standardisation_shape_ventral.chc"
  ), 
  skip = 5
)
...
png(
  here("figures", "shape_pca_ventral_Siratus_michelae.png"), 
  res = 300
)
x11()
plot_PCA(
...
# )
plot_PCA(shape_pca, axes = c(1,2), labelpoints = T, zoom = 1.7)
